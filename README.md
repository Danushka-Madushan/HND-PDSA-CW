...
## 2. Problem Statement: The Sri Lankan Context
...
### 4.1 · Customer Lookup — Trie (Prefix Tree) with Linked Lists
> `src/dsa/trie_ds.ts`
...
### 4.2 · Outage Prioritization — Max-Heap & HeapSort
> `src/dsa/heap_ds.ts`
...
### 4.3 · Route Optimization — Graph Theory & Dijkstra's Algorithm
> `src/dsa/graph_ds.ts`
...
## 5. Algorithmic Efficiency & Scalability
...
| **Route Path** | $O(\text{Trial \& Error})$ | **Dijkstra + Min-Heap** | $O((E+V) \log V)$ |
| **Update Grid** | High Overhead | **Adjacency List Mod** | $O(1)$ |

---

## 6. System Functionalities & Visual Analysis
